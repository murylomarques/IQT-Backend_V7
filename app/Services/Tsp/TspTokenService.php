...
class TspTokenService
{
    public function issueToken(string $clientId, string $clientSecret): ?array
    {
        ...
        $ttlMinutes = (int) ($client->token_ttl_minutes ?: config('tsp.token_ttl_minutes'));
    ...
    private function db()
    {
        return DB::connection(config('tsp.connection'));
    }
